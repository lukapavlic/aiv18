...
Predpogoji za oddaljeno povezovanje na EJB: podatki za povezovanje na JNDI v datoteki **jndi.properties** in Wildfly odjemalec (jboss-client.jar - najdete ga v wildfly-11.0.0.Final\bin\client).

 ...
 * 
 */
@WebServiceClient(name = "KalkulatorService", targetNamespace = "http://feri.um.si/", wsdlLocation = "http://localhost:8080/310_soap/Kalkulator?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/310_soap/Kalkulator?wsdl");
